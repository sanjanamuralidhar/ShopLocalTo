...
enum CategoryViewType { small, gird, list, block, cardLarge, cardSmall }
...
final Function(ShopModel) onPressshop;
 ...
 print(featureModel);
      ...
      case CategoryViewType.cardLarge:
        if (mylocation == null) {
          return SizedBox(
            width: 135,
            height: 160,
      ...
      case CategoryViewType.cardSmall:
      if (shopModel == null) {
          return Shimmer.fromColors(
            child: Row(
              children: <Widget>[
